...
export default (state, action) => {
    console.log("search reducer: " + JSON.stringify(state) + " action: "
     + JSON.stringify(action) + JSON.stringify(action.results));
    ...
    switch(action.type) {
        case SEARCH_SUCCESS:
            console.log("Search_Sucesss : Transform:1 " + JSON.stringify(action.results));            
